...
namespace ModularityQuickLinks\Helper;
...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITY_QUICK_LINKS_PATH . apply_filters(
            'ModularityQuickLinks/Helper/CacheBust/RevManifestPath',
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITY_QUICK_LINKS_PATH . ' and run gulp. See ' . MODULARITY_QUICK_LINKS_PATH . 'README.md for more info.</div>';
        }
    }
}
