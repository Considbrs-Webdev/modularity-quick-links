...
if (!function_exists('modularity_quick_links_render_blade_view')) {
    function modularity_quick_links_render_blade_view($view, $data = [], $compress = true)
    {
        ...
        $viewPath = MODULARITY_QUICK_LINKS_MODULE_VIEW_PATH;
